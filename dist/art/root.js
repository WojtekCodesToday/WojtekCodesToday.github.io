...
export default {
  ...
  css: "/blog.css",
  render: () => {
    return roost.convertJSX(roost.convertJSX, null, roost.convertJSX("style", null, ART_STYLE), roost.convertJSX("div", {
      id: "page"
    }, roost.convertJSX("div", {
      className: "manga_panel",
      id: "art"
    }, roost.convertJSX("h1", null, "Art"), "I won't be surprised if they suddenly dissapear or even worse...", roost.convertJSX("br", null), "Some of these are put to Postimages by myself incase it's gone, i hope they're fine with that...", roost.convertJSX("br", null), roost.convertJSX("a", {
      href: "/manga"
    }, "For extra look at what i've made"), roost.convertJSX("br", null), roost.convertJSX("br", null), roost.convertJSX("div", {
      id: "art_container",
      className: "art-grid"
    }, " "))));
  },
