...
function hamburger() {
  ...
  const NavButton = (title, path) => roost.convertJSX("button", {
    onclick: `window.loadRoute('${path}')`
  }, title);
  const navbar = roost.convertJSX("div", {
  ...
  }, NavButton("home", "/"), NavButton("blog", "/blog"), NavButton("manga", "/manga"), NavButton("art", "/art"), roost.convertJSX("button", {
